...
export default function OndeAnunciado({ embutido = false }) {
  ...
  return (
    <div style={embutido ? { maxWidth: 1100, margin: "0 auto" } : pageWrap(1100)}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1rem", flexWrap: "wrap" }}>
        ...
        {!embutido && <h2 style={{ margin: 0, fontSize: 20, fontWeight: 500, flex: 1, color: "var(--primary-dark)" }}>Controle de Anúncios</h2>}
        {embutido && <span style={{ flex: 1 }} />}
